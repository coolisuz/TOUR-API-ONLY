...
/* eslint-disable */
console.log('hello from client side'); // const locations = JSON.parse(document.getElementById('map').dataset.locations);
// console.log(locations)

var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY29vbGlzdXoiLCJhIjoiY2s3azQwbGI1MDFkMDNub2RxY2x3YXB2aCJ9.8o0dDEbuF-3jZ62DX-_WDg';
...
var stripe = Stripe('pk_test_Rf9u0wPSqimghxEbKdRcxzcc00owlGprU0');
